...
def bse(stock = 'RCOM', fdate = '12/03/2018', tdate = '16/03/2018' ):
    ...
    try:
        ...
        fromdate.clear()
        fromdate.send_keys(fdate)
        driver.execute_script("document.getElementById('ctl00_ContentPlaceHolder1_txtToDate').value = '{}'".format(tdate))
        scrip.clear()
        scrip.send_keys(stock)
        time.sleep(10)
